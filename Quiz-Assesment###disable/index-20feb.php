...
//$con = mysqli_connect("localhost","root","","skill_register") or die(mysqli_error());
...
<label><input type="checkbox" class="excellence_skills" name="excellence_skills_name" value="collapse5"> Excellence Skills</label>
 ...
 <input type="hidden" name="skills[]" value="Excellence Skills"/>
                  ...
                  <div class="card-header mb-3" id="headingTwo01">  <h4 class="heading">Finance Skills</h4></div>
                    <div class="row skill-rating">
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio1a1" value="Expert" name="subskill_value_2_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio2a1" value="Proficient" name="subskill_value_2_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="cz22" value="Demonstrating" name="subskill_value_2_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio4as1" value="Basic" name="subskill_value_2_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio5as2" value="None/Low" name="subskill_value_2_0[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio01as" value="Expert" name="subskill_value_2_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio02we" value="Proficient" name="subskill_value_2_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="c2" value="Demonstrating" name="subskill_value_2_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="c4" value="Basic" name="subskill_value_2_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio05s" value="None/Low" name="subskill_value_2_1[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio11az" value="Expert" name="subskill_value_2_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio22zz" value="Proficient" name="subskill_value_2_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio33aaa" value="Demonstrating"
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customRadio44vv" value="Basic" name="subskill_value_2_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="customww" value="None/Low" name="subskill_value_2_2[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="c41" value="Expert" name="subskill_value_2_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="c56" value="Proficient" name="subskill_value_2_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="c57" value="Proficient" name="subskill_value_2_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="c21" value="Basic" name="subskill_value_2_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input finance_skill_group" id="c22" value="None/Low" name="subskill_value_2_3[]">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row skill-rating">
                            ...
                            <div class="form-group col-md-12">
                              <div> <span class="num">5. </span><label class="label">SAP </label>
                                ...
                                <p><small><em>(The rating of this parameter is based on knowledge & hands on experience
                                      with SAP modules including SAP FICO, HRM, SD etc)</em></small></p>
                              </div>

                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd1" value="Expert" name="additional_informationvalues_2_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd2" value="Proficient" name="additional_informationvalues_2_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd3" value="Demonstrating" name="additional_informationvalues_2_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd4" value="Basic" name="additional_informationvalues_2_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd6" value="None/Low" name="additional_informationvalues_2_0[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd7" value="Expert" name="additional_informationvalues_2_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd8" value="Proficient" name="additional_informationvalues_2_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd9" value="Demonstrating" name="additional_informationvalues_2_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd10" value="Basic" name="additional_informationvalues_2_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd11" value="None/Low" name="additional_informationvalues_2_1[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd12" value="Expert" name="additional_informationvalues_2_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd13" value="Proficient" name="additional_informationvalues_2_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd14" value="Demonstrating" name="additional_informationvalues_2_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd15" value="Basic" name="additional_informationvalues_2_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd16" value="None/Low" name="additional_informationvalues_2_2[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd17" value="Expert" name="additional_informationvalues_2_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd18" value="Proficient" name="additional_informationvalues_2_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd19" value="Demonstrating" name="additional_informationvalues_2_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd20" value="Basic" name="additional_informationvalues_2_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd21" value="None/Low" name="additional_informationvalues_2_3[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd22" value="Expert" name="additional_informationvalues_2_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd23" value="Proficient" name="additional_informationvalues_2_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd24" value="Demonstrating" name="additional_informationvalues_2_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd25" value="Basic" name="additional_informationvalues_2_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd26" value="None/Low" name="additional_informationvalues_2_4[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd27" value="Expert" name="additional_informationvalues_2_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd28" value="Proficient" name="additional_informationvalues_2_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd29" value="Demonstrating" name="additional_informationvalues_2_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd30" value="Basic" name="additional_informationvalues_2_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input finance_skill_group" id="gbfd31" value="None/Low" name="additional_informationvalues_2_5[]">
                  ...
                  <div class="card-header mb-3" id="headingTwo01">  <h4 class="heading">Travel Skills</h4></div>	
                    <div class="row skill-rating">
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="cvaa" value="Expert" name="subskill_value_3_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="customRadio2as1" value="Proficient" name="subskill_value_3_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom222" value="Demonstrating" name="subskill_value_3_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom221" value="Basic" name="subskill_value_3_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom2224" value="None/Low" name="subskill_value_3_0[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="customr11" value="Expert" name="subskill_value_3_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="customr112" value="Proficient" name="subskill_value_3_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="customr113" value="Demonstrating" name="subskill_value_3_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="customr114" value="Basic" name="subskill_value_3_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="customr115" value="None/Low" name="subskill_value_3_1[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom432" value="Expert" name="subskill_value_3_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom433" value="Proficient" name="subskill_value_3_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom434" value="Demonstrating" name="subskill_value_3_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom435" value="Basic" name="subskill_value_3_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input travel_skill_group" id="custom436" value="None/Low" name="subskill_value_3_2[]">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row skill-rating">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs123" value="Expert" name="additional_informationvalues_3_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs124" value="Proficient" name="additional_informationvalues_3_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs125" value="Demonstrating" name="additional_informationvalues_3_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs126" value="Basic" name="additional_informationvalues_3_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs127" value="None/Low" name="additional_informationvalues_3_0[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs128" value="Expert" name="additional_informationvalues_3_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs129" value="Proficient" name="additional_informationvalues_3_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs130" value="Demonstrating" name="additional_informationvalues_3_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs131" value="Basic" name="additional_informationvalues_3_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs132" value="None/Low" name="additional_informationvalues_3_1[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs133" value="Expert" name="additional_informationvalues_3_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs134" value="Proficient" name="additional_informationvalues_3_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs135" value="Demonstrating" name="additional_informationvalues_3_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs136" value="Basic" name="additional_informationvalues_3_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input travel_skill_group" id="cs137" value="None/Low" name="additional_informationvalues_3_2[]">
                  ...
                  <div class="card-header mb-3" id="headingTwo01">  <h4 class="heading"> Technology Skills</h4>	</div>
                    <div class="row skill-rating">
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2231" value="Expert" name="subskill_value_4_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2232" value="Proficient" name="subskill_value_4_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2233" value="Demonstrating" name="subskill_value_4_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2234" value="Basic" name="subskill_value_4_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2235" value="None/Low" name="subskill_value_4_0[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2236" value="Expert" name="subskill_value_4_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2237" value="Proficient" name="subskill_value_4_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2238" value="Demonstrating" name="subskill_value_4_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2239" value="Basic" name="subskill_value_4_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2241" value="None/Low" name="subskill_value_4_1[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2242" value="Expert" name="subskill_value_4_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2243" value="Proficient" name="subskill_value_4_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2244" value="Demonstrating" name="subskill_value_4_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2245" value="Basic" name="subskill_value_4_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="custom2246" value="None/Low" name="subskill_value_4_2[]">
                      ...
                      <div class="form-group col-md-12">
						...
						<span id="subskill_label_value_4_3" style="color: #d22424; display:none"> ( Required )</span>
                          ...
                          <p><small><em>(The rating of this parameter is based on skills of Hypertext Preprocessor & server-side scripting)</em></small></p>
                        </div>

                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="cus551" value="Expert" name="subskill_value_4_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="cus552" value="Proficient" name="subskill_value_4_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="cus553" value="Demonstrating" name="subskill_value_4_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="cus554" value="Basic" name="subskill_value_4_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input technology_skill_group" id="cus555" value="None/Low" name="subskill_value_4_3[]">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row skill-rating">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom1" value="Expert" name="additional_informationvalues_4_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom2" value="Proficient" name="additional_informationvalues_4_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom3" value="Demonstrating" name="additional_informationvalues_4_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom3" value="Basic" name="additional_informationvalues_4_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom4" value="None/Low" name="additional_informationvalues_4_0[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom5" value="Expert" name="additional_informationvalues_4_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom6" value="Proficient" name="additional_informationvalues_4_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom7" value="Demonstrating" name="additional_informationvalues_4_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom8" value="Basic" name="additional_informationvalues_4_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom9" value="None/Low" name="additional_informationvalues_4_1[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom10" value="Expert" name="additional_informationvalues_4_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom11" value="Proficient" name="additional_informationvalues_4_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom12" value="Demonstrating" name="additional_informationvalues_4_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom13" value="Basic" name="additional_informationvalues_4_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom14" value="None/Low" name="additional_informationvalues_4_2[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom15" value="Expert" name="additional_informationvalues_4_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom16" value="Proficient" name="additional_informationvalues_4_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom17" value="Demonstrating" name="additional_informationvalues_4_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom18" value="Basic" name="additional_informationvalues_4_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom19" value="None/Low" name="additional_informationvalues_4_3[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom20" value="Expert" name="additional_informationvalues_4_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom21" value="Proficient" name="additional_informationvalues_4_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom22" value="Demonstrating" name="additional_informationvalues_4_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom23" value="Basic" name="additional_informationvalues_4_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom24" value="None/Low" name="additional_informationvalues_4_4[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom25" value="Expert" name="additional_informationvalues_4_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom26" value="Proficient" name="additional_informationvalues_4_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom27" value="Demonstrating" name="additional_informationvalues_4_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom28" value="Basic" name="additional_informationvalues_4_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom29" value="None/Low" name="additional_informationvalues_4_5[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom30" value="Expert" name="additional_informationvalues_4_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom31" value="Proficient" name="additional_informationvalues_4_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom32" value="Demonstrating" name="additional_informationvalues_4_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom33" value="Basic" name="additional_informationvalues_4_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom34" value="None/Low" name="additional_informationvalues_4_6[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom35" value="Expert" name="additional_informationvalues_4_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom36" value="Proficient" name="additional_informationvalues_4_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom37" value="Demonstrating" name="additional_informationvalues_4_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom38" value="Basic" name="additional_informationvalues_4_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom39" value="None/Low" name="additional_informationvalues_4_7[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom40" value="Expert" name="additional_informationvalues_4_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom41" value="Proficient" name="additional_informationvalues_4_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom42" value="Demonstrating" name="additional_informationvalues_4_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom43" value="Basic" name="additional_informationvalues_4_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom44" value="None/Low" name="additional_informationvalues_4_8[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom45" value="Expert" name="additional_informationvalues_4_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom46" value="Proficient" name="additional_informationvalues_4_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom47" value="Demonstrating" name="additional_informationvalues_4_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom48" value="Basic" name="additional_informationvalues_4_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input technology_skill_group" id="tom49" value="Basic" name="additional_informationvalues_4_9[]">
                  ...
                  <div class="card-header mb-3" id="headingTwo01">  <h4 class="heading">BFSI Skills</h4></div>
                    <div class="row skill-rating">
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="ww11" value="Expert" name="subskill_value_5_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="ww12" value="Proficient" name="subskill_value_5_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="ww13" value="Demonstrating" name="subskill_value_5_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="ww14" value="Basic" name="subskill_value_5_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="ww15" value="None/Low" name="subskill_value_5_0[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas1" value="Expert" name="subskill_value_5_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas2" value="Proficient" name="subskill_value_5_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas3" value="Demonstrating" name="subskill_value_5_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas4" value="Basic" name="subskill_value_5_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas5" value="None/Low" name="subskill_value_5_1[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas6" value="Expert" name="subskill_value_5_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas7" value="Proficient" name="subskill_value_5_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas8" value="Demonstrating" name="subskill_value_5_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas9" value="Basic" name="subskill_value_5_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input bfsi_skill_group" id="zas10" value="None/Low" name="subskill_value_5_2[]">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row skill-rating">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom100" value="Expert" name="additional_informationvalues_5_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom101" value="Proficient" name="additional_informationvalues_5_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom102" value="Demonstrating" name="additional_informationvalues_5_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom103" value="Basic" name="additional_informationvalues_5_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom104" value="None/Low" name="additional_informationvalues_5_0[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom105" value="Expert" name="additional_informationvalues_5_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom106" value="Proficient" name="additional_informationvalues_5_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom107" value="Demonstrating" name="additional_informationvalues_5_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom108" value="Basic" name="additional_informationvalues_5_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="tom109" value="None/Low" name="additional_informationvalues_5_1[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="top10" value="Expert" name="additional_informationvalues_5_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="top11" value="Proficient" name="additional_informationvalues_5_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="top12" value="Demonstrating" name="additional_informationvalues_5_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="top13" value="Basic" name="additional_informationvalues_5_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input bfsi_skill_group" id="top14" value="None/Low" name="additional_informationvalues_5_2[]">
                  ...
                  <div class="card-header mb-3" id="headingTwo01">  <h4 class="heading">Utility Skills</h4></div>
                    <div class="row skill-rating">
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq1" value="Expert" name="subskill_value_6_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq2" value="Proficient" name="subskill_value_6_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq3" value="Demonstrating" name="subskill_value_6_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq4" value="Basic" name="subskill_value_6_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq5" value="None/Low" name="subskill_value_6_0[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq6" value="Expert" name="subskill_value_6_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq7" value="Proficient" name="subskill_value_6_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq8" value="Demonstrating" name="subskill_value_6_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq9" value="Basic" name="subskill_value_6_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="czzaq10" value="None/Low" name="subskill_value_6_1[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="qwasas22" value="Expert" name="subskill_value_6_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="qwasas23" value="Proficient" name="subskill_value_6_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="qwasas24" value="Demonstrating" name="subskill_value_6_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="qwasas25" value="Basic" name="subskill_value_6_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input utility_skill_group" id="qwasas26" value="None/Low" name="subskill_value_6_2[]">
                  ...
                  <div class="card-header mb-3" id="headingTwo01">  <h4 class="heading">ITSM Skills</h4></div>
                    <div class="row skill-rating">
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc10" value="Expert" name="subskill_value_7_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc12" value="Proficient" name="subskill_value_7_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc13" value="Demonstrating" name="subskill_value_7_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc14" value="Basic" name="subskill_value_7_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc15" value="None/Low" name="subskill_value_7_0[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc16" value="Expert" name="subskill_value_7_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc17" value="Proficient" name="subskill_value_7_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc18" value="Demonstrating" name="subskill_value_7_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc19" value="Basic" name="subskill_value_7_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc20" value="None/Low" name="subskill_value_7_1[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc21" value="Expert" name="subskill_value_7_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc22" value="Proficient" name="subskill_value_7_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc23" value="Demonstrating" name="subskill_value_7_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc24" value="Basic" name="subskill_value_7_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input itms_skill_group" id="customc25" value="None/Low" name="subskill_value_7_2[]">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row skill-rating">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp1" value="Expert" name="additional_informationvalues_7_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp2" value="Proficient" name="additional_informationvalues_7_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp3" value="Demonstrating" name="additional_informationvalues_7_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp4" value="Basic" name="additional_informationvalues_7_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp5" value="None/Low" name="additional_informationvalues_7_0[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp6" value="Expert" name="additional_informationvalues_7_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp7" value="Proficient" name="additional_informationvalues_7_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp8" value="Demonstrating" name="additional_informationvalues_7_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp9" value="Basic" name="additional_informationvalues_7_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp10" value="None/Low" name="additional_informationvalues_7_1[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp11" value="Expert" name="additional_informationvalues_7_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp12" value="Proficient" name="additional_informationvalues_7_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp13" value="Demonstrating" name="additional_informationvalues_7_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp14" value="Basic" name="additional_informationvalues_7_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp15" value="None/Low" name="additional_informationvalues_7_2[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp16" value="Expert" name="additional_informationvalues_7_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp17" value="Proficient" name="additional_informationvalues_7_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp18" value="Demonstrating" name="additional_informationvalues_7_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp19" value="Basic" name="additional_informationvalues_7_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp20" value="None/Low" name="additional_informationvalues_7_3[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp21" value="Expert" name="additional_informationvalues_7_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp22" value="Proficient" name="additional_informationvalues_7_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp23" value="Demonstrating" name="additional_informationvalues_7_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp24" value="Basic" name="additional_informationvalues_7_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp25" value="None/Low" name="additional_informationvalues_7_4[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp26" value="Expert" name="additional_informationvalues_7_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp27" value="Proficient" name="additional_informationvalues_7_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp28" value="Demonstrating" name="additional_informationvalues_7_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp29" value="Basic" name="additional_informationvalues_7_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp30" value="None/Low" name="additional_informationvalues_7_5[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp31" value="Expert" name="additional_informationvalues_7_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp32" value="Proficient" name="additional_informationvalues_7_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp33" value="Demonstrating" name="additional_informationvalues_7_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp34" value="Basic" name="additional_informationvalues_7_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp35" value="None/Low" name="additional_informationvalues_7_6[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp36" value="Expert" name="additional_informationvalues_7_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp37" value="Proficient" name="additional_informationvalues_7_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp38" value="Demonstrating" name="additional_informationvalues_7_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp39" value="Basic" name="additional_informationvalues_7_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp40" value="None/Low" name="additional_informationvalues_7_7[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp41" value="Expert" name="additional_informationvalues_7_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp42" value="Proficient" name="additional_informationvalues_7_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp43" value="Demonstrating" name="additional_informationvalues_7_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp44" value="Basic" name="additional_informationvalues_7_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input itms_skill_group" id="ppp45" value="None/Low" name="additional_informationvalues_7_8[]">
              ...
              <div class="card">
                  ...
                  <div class="card-header mb-3" id="headingTwo01">  <h4 class="heading">Excellence Skills</h4></div>
                    <div class="row skill-rating">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio11" value="Expert" name="subskill_value_8_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio12" value="Proficient" name="subskill_value_8_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio13" value="Demonstrating" name="subskill_value_8_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio14" value="Basic" name="subskill_value_8_0[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio15" value="None/Low" name="subskill_value_8_0[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio16" value="Expert" name="subskill_value_8_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio17" value="Proficient" name="subskill_value_8_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio18" value="Demonstrating" name="subskill_value_8_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio19" value="Basic" name="subskill_value_8_1[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio20" value="None/Low" name="subskill_value_8_1[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio21" value="Expert" name="subskill_value_8_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio22" value="Proficient" name="subskill_value_8_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio23" value="Demonstrating" name="subskill_value_8_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio24" value="Basic" name="subskill_value_8_2[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio25" value="None/Low" name="subskill_value_8_2[]">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio26" value="Expert" name="subskill_value_8_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio27" value="Proficient" name="subskill_value_8_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio27" value="Demonstrating" name="subskill_value_8_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio28" value="Basic" name="subskill_value_8_3[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio29" value="None/Low" name="subskill_value_8_3[]">
                      ...
                      <div class="form-group col-md-12">
						...
						<span id="subskill_label_value_8_4" style="color: #d22424; display:none"> ( Required )</span>
                          ...
                          <p><small><em>(PDCA (plan do check act or plan do check adjust) is an iterative
                                ...
                                Shewhart cycle, the control circle/cycle, or plan do study act (PDSA).)</em></small></p>
                        </div>

                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio30" value="Expert" name="subskill_value_8_4[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio31" value="Proficient" name="subskill_value_8_4[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio32" value="Demonstrating" name="subskill_value_8_4[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio33" value="Basic" name="subskill_value_8_4[]">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input excellence_skill_group" id="Radio34" value="None/Low" name="subskill_value_8_4[]">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row skill-rating">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp1" value="Expert" name="additional_informationvalues_8_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp2" value="Proficient" name="additional_informationvalues_8_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp3" value="Demonstrating" name="additional_informationvalues_8_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp4" value="Basic" name="additional_informationvalues_8_0[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp5" value="None/Low" name="additional_informationvalues_8_0[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp6" value="Expert" name="additional_informationvalues_8_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp7" value="Proficient" name="additional_informationvalues_8_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp8" value="Demonstrating" name="additional_informationvalues_8_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp9" value="Basic" name="additional_informationvalues_8_1[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp10" value="None/Low" name="additional_informationvalues_8_1[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp11" value="Expert" name="additional_informationvalues_8_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp12" value="Proficient" name="additional_informationvalues_8_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp13" value="Demonstrating" name="additional_informationvalues_8_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp14" value="Basic" name="additional_informationvalues_8_2[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp15" value="None/Low" name="additional_informationvalues_8_2[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp16" value="Expert" name="additional_informationvalues_8_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp17" value="Proficient" name="additional_informationvalues_8_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp18" value="Demonstrating" name="additional_informationvalues_8_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp19" value="Basic" name="additional_informationvalues_8_3[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp20" value="None/Low" name="additional_informationvalues_8_3[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp21" value="Expert" name="additional_informationvalues_8_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp22" value="Proficient" name="additional_informationvalues_8_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp23" value="Demonstrating" name="additional_informationvalues_8_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp24" value="Basic" name="additional_informationvalues_8_4[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp25" value="None/Low" name="additional_informationvalues_8_4[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp26" value="Expert" name="additional_informationvalues_8_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp27" value="Proficient" name="additional_informationvalues_8_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp28" value="Demonstrating" name="additional_informationvalues_8_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp29" value="Basic" name="additional_informationvalues_8_5[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp30" value="None/Low" name="additional_informationvalues_8_5[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp31" value="Expert" name="additional_informationvalues_8_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp32" value="Proficient" name="additional_informationvalues_8_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp33" value="Demonstrating" name="additional_informationvalues_8_6[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp33_1" value="Basic" name="additional_informationvalues_8_6[]">
                                <label class="custom-control-label" for="yp33_1">Basic
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp34" value="None/Low" name="additional_informationvalues_8_6[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp35" value="Expert" name="additional_informationvalues_8_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp36" value="Proficient" name="additional_informationvalues_8_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp37" value="Demonstrating" name="additional_informationvalues_8_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp38" value="Basic" name="additional_informationvalues_8_7[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp39" value="None/Low" name="additional_informationvalues_8_7[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp40" value="Expert" name="additional_informationvalues_8_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp41" value="Proficient" name="additional_informationvalues_8_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp42" value="Demonstrating" name="additional_informationvalues_8_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp44" value="Basic" name="additional_informationvalues_8_8[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp45" value="None/Low" name="additional_informationvalues_8_8[]">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp46" value="Expert" name="additional_informationvalues_8_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp47" value="Proficient" name="additional_informationvalues_8_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp48" value="Demonstrating" name="additional_informationvalues_8_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp49" value="Basic" name="additional_informationvalues_8_9[]">
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input excellence_skill_group" id="yp50" value="None/Low" name="additional_informationvalues_8_9[]">
				...
				<p style="color:red; display:none;" id="certification_checkbox"> &nbsp;&nbsp; At least one field must be selected</p>
                <div id="collapseThree" class="collapse cc show" aria-labelledby="headingTwo" data-parent="">
                  <div class="card-body">
					...
					<!-- for single container-->	
					 <div class="row">
                      ...
                      <div class="form-group">
                         ...
                         <input type="text"  id="certification_other" class="form-control"  name="certification[]" value="">
                         <input type="checkbox" name="certification[]" value="None"> None<br>
		...
		if(this.checked) // if changed state is "CHECKED"
			{
				$("#collapseTwo01").addClass("show");
				 ...
				 $(".finance_skill_group").prop("checked", false);
		...
		if(this.checked) // if changed state is "CHECKED"
			{
				$("#collapseTwo2").addClass("show");
				 ...
				 $(".travel_skill_group").prop("checked", false);
		...
		if(this.checked) // if changed state is "CHECKED"
			{
				$("#collapseTwo3").addClass("show");
				 ...
				 $(".technology_skill_group").prop("checked", false);
		...
		if(this.checked) // if changed state is "CHECKED"
			{
				$("#collapseTwo4").addClass("show");
				 ...
				 $(".bfsi_skill_group").prop("checked", false);
		...
		if(this.checked) // if changed state is "CHECKED"
			{
				$("#collapseTwo5").addClass("show");
				 ...
				 $(".utility_skill_group").prop("checked", false);
		...
		if(this.checked) // if changed state is "CHECKED"
			{
				...
				$("#collapseTw5").addClass("show");
				 ...
				 //$('.itms_skill_group').removeAttr('checked');
				 $(".itms_skill_group").prop("checked", false);
		...
		if(this.checked) // if changed state is "CHECKED"
			{
				$("#collapse5").addClass("show");
				 ...
				 $(".excellence_skill_group").prop("checked", false);
...
/* 	emp id required closed */
     ...
     /*  var lenemp = emp_id.length;
	  ...
	  /* certification-	select at least on check box */
	 var certification_other = $("#certification_other").val();
	var certification_other_len = certification_other.length;
	
	 var certification_chekboxdata = [];

      $.each($("input[name='certification[]']:checked"), function () {
        certification_chekboxdata.push($(this).val());
      });
      var checklen = certification_chekboxdata.join(", ");

      var certification_lng = checklen.length;
		//alert("certification_lng--"+certification_lng);
      if (certification_lng > 0 || certification_other_len > 0) {
	
        formsubmit = true;
		$('#certification_checkbox').hide();

      } else {
		
        formsubmit = false;
		$('#certification_checkbox').show();
      }
/* certification-	select at least on check box closed */	
